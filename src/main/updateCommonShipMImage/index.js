...
import { updateCommonShipMainImage } from '../../redux/detailCommonShip/action';

const SIZE_TITLE = Dimensions.get('screen').height * 0.04
const SIZE_SUBTITLE = Dimensions.get('screen').height * 0.02

const UpdateCommonShipMImage = (props) => {
...
const mapDispatchToProps = {
	updateCommonShipMainImage: (token, img_id, id) => updateCommonShipMainImage(token, img_id, id)
}


export default connect(mapStateToProps, mapDispatchToProps)(UpdateCommonShipMImage)